...
const GridCard = ({item}) => {
  ...
  return (
    <>
      <div className="gridCard bg-[#141414] w-[270px] p-[10px] h-[200px] cursor-pointer hover:bg-[#202020] rounded-lg shadow-lg shadow-black/50">
        ...
        <div className="flex items-center justify-between">
            ...
            <img onClick={()=>{setIsDeleteModelShow(true)}} className="w-[35px] cursor-pointer mb-2 pr-1" src={deleteImg} alt=""/>
        </div>
      </div>
